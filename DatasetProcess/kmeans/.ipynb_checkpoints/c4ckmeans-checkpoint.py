...
"""
1. 仅对train集的9000个视频进行聚类  DONE
2. 对于test集的视频，根据表征的相似性，选择train集中表征最相似的视频的id序列 Done
"""

parser = argparse.ArgumentParser()
parser.add_argument('--seed', type=int, default=34)
parser.add_argument('--k', type=int, default= 10)   # 30
parser.add_argument('--c', type=int, default= 10)  # 30
