...
parser.add_argument('--k', type=int, default= 100)   # 30
parser.add_argument('--c', type=int, default= 100)  # 30

args = parser.parse_args()

# # 获得训练用的video id及对应的s3d features
...
# print(X.shape);input('s') # (10000, 15872)
